] as const;

type Track = "" | "International AIESECer" | "EP";
type Position = "" | "None" | "Manager" | "Team Leader" | "LCVP" | "LCP";
type FormState = { firstName: string; lastName: string; passportNumber: string; phoneCountry: string; phone: string; email: string; track: Track; position: Position; singleRoom: boolean; department: string; lcName: string; entityName: string; countryOfOrigin: string; allergies: string; note: string; indemnitySignature: string; indemnityAccepted: boolean; };
...
const initial: FormState = { firstName: "", lastName: "", passportNumber: "", phoneCountry: "+216", phone: "", email: "", track: "", position: "", singleRoom: false, department: "", lcName: "", entityName: "", countryOfOrigin: "", allergies: "", note: "", indemnitySignature: "", indemnityAccepted: false };
const informationFields: Array<keyof FormState> = ["firstName", "lastName", "passportNumber", "phoneCountry", "phone", "email"];

function participationFieldsForTrack(track: Track): Array<keyof FormState> {
  return track === "International AIESECer"
    ? ["track", "position", "department", "lcName", "entityName", "allergies", "note"]
    : ["track", "countryOfOrigin", "allergies", "note"];
}

function contribution(form: Pick<FormState, "track" | "singleRoom">) {
  return getContribution(form.track, form.singleRoom);
}
...
export default function Register() {
  ...
  const validate = (fields: Array<keyof FormState>) => {
    ...
    if (fields.includes("passportNumber") && !form.passportNumber.trim()) next.passportNumber = "Passport number is required.";
    if (fields.includes("phoneCountry") && !form.phoneCountry) next.phoneCountry = "Select a country code.";
    if (fields.includes("phone") && !form.phone.trim()) next.phone = "Phone number is required.";
    if (fields.includes("email") && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/i.test(form.email.trim())) next.email = "Use a valid email address.";
    if (fields.includes("track") && !form.track) next.track = "Select your participant type.";
    if (fields.includes("position") && form.track === "International AIESECer" && !form.position) next.position = "Select a position.";
    if (fields.includes("department") && form.track === "International AIESECer" && (!form.department || (form.department === "Other" && !otherDepartment.trim()))) next.department = "Select or enter a department.";
    if (fields.includes("lcName") && form.track === "International AIESECer" && !form.lcName.trim()) next.lcName = "Enter your LC name.";
    if (fields.includes("entityName") && form.track === "International AIESECer" && !form.entityName.trim()) next.entityName = "Enter your entity name.";
    if (fields.includes("countryOfOrigin") && form.track === "EP" && !form.countryOfOrigin.trim()) next.countryOfOrigin = "Enter your country of origin.";
  ...
  const continueToSignature = () => { if (validate(participationFieldsForTrack(form.track)) && validateAttachments()) goTo(3); };
  ...
  const submit = async (event: FormEvent) => {
    ...
    const participationValidationFields = participationFieldsForTrack(form.track);
    ...
    if (!form.track) { setStage(2); return; }
    const track = form.track;
    const position: Exclude<Position, ""> = track === "EP" ? "None" : form.position as Exclude<Position, "">;
    const selectedDepartment = track === "EP" ? "None" : form.department === "Other" ? otherDepartment.trim() : form.department;
    const selectedLcName = track === "EP" ? "None" : form.lcName.trim();
    const selectedEntityName = track === "EP" ? "None" : form.entityName.trim();
    const selectedCountryOfOrigin = track === "EP" ? form.countryOfOrigin.trim() : "None";
    ...
    try {
      const confirmation = await submitRegistration.mutateAsync({ ...form, passportNumber: form.passportNumber.trim(), phoneCountry: form.phoneCountry.trim(), phone: form.phone.trim(), department: selectedDepartment, lcName: selectedLcName, entityName: selectedEntityName, countryOfOrigin: selectedCountryOfOrigin, track, position, price: selectedFee.price, currency: selectedFee.currency, photoUrl: nextDocuments?.photo?.url ?? "", photoName: nextDocuments?.photo?.name ?? "", cvUrl: nextDocuments?.cv?.url ?? "", cvName: nextDocuments?.cv?.name ?? "", identityUrl: nextDocuments?.identity?.url ?? "", identityName: nextDocuments?.identity?.name ?? "" });
      const receiptDocuments = confirmation.documents ?? nextDocuments ?? {};
      setReceipt({ form: { ...form, passportNumber: form.passportNumber.trim(), phoneCountry: form.phoneCountry.trim(), phone: form.phone.trim(), department: selectedDepartment, lcName: selectedLcName, entityName: selectedEntityName, position, countryOfOrigin: selectedCountryOfOrigin }, price: selectedFee.price, currency: selectedFee.currency, contributionNote: selectedFee.note, documents: receiptDocuments, reference: `LL26-${String(Date.now()).slice(-6)}`, recordedAt: new Date().toLocaleString("en-GB", { dateStyle: "medium", timeStyle: "short" }) });
      setStage("receipt");
    } catch (error) {
  ...
  return (
    <main className="registration-site chase-route chase-register cinematic-world-root">
      ...
      <div className="register-layout">
        <aside className="dossier-intro"><p className="eyebrow">CHAPTER VI / DELEGATE DOSSIER</p><h1>{stage === "receipt" ? "The record is sealed." : "Answer the call."}</h1><dl><div><dt>STARTS</dt><dd>10 September 2026</dd></div><div><dt>DURATION</dt><dd>{form.track ? `${form.track} · 3 days` : "International AIESECer · 3 days / EP · 3 days"}</dd></div><div><dt>HOST</dt><dd>LC Thyna</dd></div><div><dt>VENUE</dt><dd>Amir Palace</dd></div></dl></aside>
        <section className="dossier-panel" aria-labelledby="registration-title">
          ...
          {stage === "receipt" && receipt ? <section className="registration-receipt" aria-live="polite"><div className="receipt-seal">✓</div><p className="receipt-kicker">REGISTRATION RECEIVED</p><h3>Thank you, {receipt.form.firstName}.</h3><p className="receipt-copy">Your registration was submitted successfully.</p><div className="receipt-reference"><span>REFERENCE</span><strong>{receipt.reference}</strong></div><button className="bronze-button receipt-home" type="button" onClick={() => isEmbedded ? window.parent.postMessage({ type: "lead-lead-registration-close" }, window.location.origin) : window.location.assign("/home")}>{isEmbedded ? "CLOSE REGISTRATION" : "RETURN TO THE GATHERING"} <b>→</b></button></section> : <form onSubmit={submit} noValidate>
            {stage === 1 && <div className="registration-step registration-step--information"><p className="step-intro">Use your official details so the organising team can identify your registration.</p><div className="form-grid two"><label>First name<input value={form.firstName} onChange={(event) => update("firstName", event.target.value)} placeholder="Foulen" required aria-invalid={Boolean(errors.firstName)} />{error("firstName")}</label><label>Last name<input value={form.lastName} onChange={(event) => update("lastName", event.target.value)} placeholder="Fouléni" required aria-invalid={Boolean(errors.lastName)} />{error("lastName")}</label></div><div className="form-grid two"><label>Passport number<input value={form.passportNumber} onChange={(event) => update("passportNumber", event.target.value)} placeholder="Enter your passport number" required autoComplete="off" aria-invalid={Boolean(errors.passportNumber)} />{error("passportNumber")}</label><label>Country code<select value={form.phoneCountry} onChange={(event) => update("phoneCountry", event.target.value)} required aria-invalid={Boolean(errors.phoneCountry)}>{phoneCountries.map(([code, country]) => <option value={code} key={`${code}-${country}`}>{code} · {country}</option>)}</select>{error("phoneCountry")}</label></div><div className="form-grid two"><label>Phone number<input value={form.phone} onChange={(event) => update("phone", event.target.value)} placeholder="Enter your phone number" inputMode="tel" required aria-invalid={Boolean(errors.phone)} />{error("phone")}</label><label>Email<input type="email" value={form.email} onChange={(event) => update("email", event.target.value)} placeholder="foulen.fouleni@mail.com" autoComplete="email" required aria-invalid={Boolean(errors.email)} />{error("email")}</label></div><button className="bronze-button submit-button" type="button" onClick={continueToParticipation}>CONTINUE <b>→</b></button></div>}
            {stage === 2 && <div className="registration-step registration-step--participation"><p className="step-intro">Choose your participant type and complete only the details relevant to your profile.</p>{fee ? <div className="contribution-card"><p>YOUR CONTRIBUTION</p><strong>{fee.price} <small>{fee.currency}</small></strong><span>{fee.note} Payment is not collected through this page.</span></div> : <div className="contribution-card contribution-card--pending"><p>CONTRIBUTION</p><span>Select a participant type to reveal your contribution.</span></div>}<div className="form-grid two"><label>Participant type<select required value={form.track} onChange={(event) => { const track = event.target.value as Track; setForm((current) => ({ ...current, track, position: track === "EP" ? "None" : "", department: track === "EP" ? "None" : "", countryOfOrigin: track === "EP" ? current.countryOfOrigin : "None", lcName: track === "EP" ? "None" : "", entityName: track === "EP" ? "None" : "" })); }} aria-invalid={Boolean(errors.track)}><option value="">Select participant type</option><option>International AIESECer</option><option>EP</option></select>{error("track")}</label>{form.track === "International AIESECer" && <label>Position<select required value={form.position} onChange={(event) => update("position", event.target.value as Position)} aria-invalid={Boolean(errors.position)}><option value="">Select position</option>{["Manager", "Team Leader", "LCVP", "LCP"].map((position) => <option key={position}>{position}</option>)}</select>{error("position")}</label>}{form.track === "EP" && <label>Country of origin<input value={form.countryOfOrigin} onChange={(event) => update("countryOfOrigin", event.target.value)} placeholder="Enter your country of origin" required aria-invalid={Boolean(errors.countryOfOrigin)} />{error("countryOfOrigin")}</label>}</div>{form.track === "International AIESECer" && <div className="form-grid two"><label>LC name<input value={form.lcName} onChange={(event) => update("lcName", event.target.value)} placeholder="Write your LC name" autoComplete="organization" required aria-invalid={Boolean(errors.lcName)} />{error("lcName")}</label><label>Entity name<input value={form.entityName} onChange={(event) => update("entityName", event.target.value)} placeholder="Write your entity name" autoComplete="organization" required aria-invalid={Boolean(errors.entityName)} />{error("entityName")}</label></div>}{form.track && <label className="single-room-option"><input type="checkbox" checked={form.singleRoom} onChange={(event) => update("singleRoom", event.target.checked)} /><span><strong>Single room</strong><small>+60 EUR</small></span></label>}{form.track === "International AIESECer" && <div className="department-fields"><label>Department<select required value={form.department} onChange={(event) => { update("department", event.target.value); if (event.target.value !== "Other") setOtherDepartment(""); }} aria-invalid={Boolean(errors.department)}><option value="">Select your department</option>{departments.map((department) => <option key={department}>{department}</option>)}</select>{error("department")}</label>{form.department === "Other" && <label>Department name<input value={otherDepartment} onChange={(event) => setOtherDepartment(event.target.value)} placeholder="Write your department" required /></label>}</div>}<div className="attachment-grid"><label className="attachment-field attachment-field--identity">Passport document <small>Required · JPG, PNG, or PDF · max 5 MB</small><input type="file" accept="image/jpeg,image/png,application/pdf,.pdf" required onChange={(event) => selectAttachment("identity", event.target.files?.[0])} />{attachments.identity && <strong>{attachments.identity.name}<button type="button" onClick={() => removeAttachment("identity")}>REMOVE</button></strong>}{attachmentErrors.identity && <small className="field-error" role="alert">{attachmentErrors.identity}</small>}</label><label className="attachment-field">Profile photo <small>Required · JPG, PNG, or WebP · max 3 MB</small><input type="file" accept="image/jpeg,image/png,image/webp" required onChange={(event) => selectAttachment("photo", event.target.files?.[0])} />{attachments.photo && <strong>{attachments.photo.name}<button type="button" onClick={() => removeAttachment("photo")}>REMOVE</button></strong>}{attachmentErrors.photo && <small className="field-error" role="alert">{attachmentErrors.photo}</small>}</label><label className="attachment-field">CV / résumé <small>Required · PDF · max 15 MB</small><input type="file" accept="application/pdf,.pdf" required onChange={(event) => selectAttachment("cv", event.target.files?.[0])} />{attachments.cv && <strong>{attachments.cv.name}<button type="button" onClick={() => removeAttachment("cv")}>REMOVE</button></strong>}{attachmentErrors.cv && <small className="field-error" role="alert">{attachmentErrors.cv}</small>}</label></div><label>Allergies <small>Required · enter “None” if not applicable</small><textarea value={form.allergies} onChange={(event) => update("allergies", event.target.value)} rows={3} placeholder="List allergies or dietary concerns, or enter None" required aria-invalid={Boolean(errors.allergies)} />{error("allergies")}</label><label>Additional note <small>Required · enter “None” if not applicable</small><textarea value={form.note} onChange={(event) => update("note", event.target.value)} rows={3} placeholder="Add a note for the organising team, or enter None" required aria-invalid={Boolean(errors.note)} />{error("note")}</label><div className="registration-actions"><button className="step-back-button" type="button" onClick={() => goTo(1)}>← BACK</button><button className="bronze-button" type="button" onClick={continueToSignature}>SIGNATURE <b>→</b></button></div></div>}
            ...
            {stage === 4 && <div className="registration-step registration-review"><p className="step-intro">Review your information before submitting it. A receipt appears only after the registration sheet confirms your record.</p><div className="review-grid"><section className="review-section"><h4>Delegate</h4><p>{form.firstName} {form.lastName}</p><p>Passport: {form.passportNumber}</p><p>{form.email}</p></section><section className="review-section"><h4>Participation</h4><p>{form.track || "Participant type pending"}{form.track === "International AIESECer" ? ` / ${form.position || "Position pending"}` : ""}</p>{form.track === "International AIESECer" ? <><p>{form.department === "Other" ? otherDepartment || "Department pending" : form.department || "Department pending"}</p><p>LC: {form.lcName || "LC pending"}</p><p>Entity: {form.entityName || "Entity pending"}</p></> : <p>Country of origin: {form.countryOfOrigin || "Country pending"}</p>}<p>{form.singleRoom ? "Single room · +60 EUR" : "Shared room"}</p><p>Virtual indemnity signature captured</p></section></div><div className="registration-actions"><button className="step-back-button" type="button" onClick={() => goTo(3)}>← BACK</button><button className="bronze-button" disabled={status === "sending" || uploadDocuments.isPending || submitRegistration.isPending} type="submit">{status === "sending" || uploadDocuments.isPending || submitRegistration.isPending ? "RECORDING…" : "SUBMIT REGISTRATION"}<b>→</b></button></div>{status === "sending" && <p className="form-status" role="status">Saving your registration. Please keep this page open.</p>}{status === "upload" && <p className="form-status error" role="alert">Error: registration not submitted.</p>}{status === "error" && <p className="form-status error" role="alert">Error: registration not submitted.</p>}</div>}
          </form>}
        </section>
      </div>
