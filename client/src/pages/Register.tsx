...
type FormState = { firstName: string; lastName: string; passportNumber: string; phoneCountry: string; phone: string; email: string; track: Track; position: Position; singleRoom: boolean; department: string; countryOfOrigin: string; allergies: string; note: string; indemnitySignature: string; indemnityAccepted: boolean; };
...
const initial: FormState = { firstName: "", lastName: "", passportNumber: "", phoneCountry: "+216", phone: "", email: "", track: "", position: "", singleRoom: false, department: "", countryOfOrigin: "", allergies: "", note: "", indemnitySignature: "", indemnityAccepted: false };
...
function participationFieldsForTrack(track: Track): Array<keyof FormState> {
  return track === "International AIESECer"
    ? ["track", "position", "department", "allergies", "note"]
